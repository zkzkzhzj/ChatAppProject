 ...
 *
 * 1. git commit → 새 도메인/컨트롤러/이벤트 파일 vs docs 갱신 여부 경고 (advisory)
...
function checkDocsConsistency(cwd) {
  const stagedOutput = git("diff --cached --name-only", cwd);
