...
|------|------|------|------|------|--------|
| 1 | 하네스/트랙 정책 교정 | — | 🔧 진행 | #116 | TBD |
| 2 | 백엔드 구조 조사 + 도메인/API 상세 설계 | Step 1 | ✅ 완료 | #116 | 2c5e6f9 |
| 3 | 고백 기록 도메인 골격 | Step 2 | 대기 | #116 | TBD |
| 4 | 고백 기록 영속성/마이그레이션 | Step 3 | 대기 | #116 | TBD |
| 5 | 고백 기록 API | Step 4 | 대기 | #116 | TBD |
| 6 | 비공개 편지/감사 답장 | Step 5 | 대기 | #116 | TBD |
| 7 | 이모지 공감 + 위험 감지/신고 진입점 | Step 5 | 대기 | #116 | TBD |
...
현재는 Step 1 하네스/트랙 정책 교정 진행 중이다.
...
- 다음 작업 커밋은 Step 3 고백 기록 도메인 골격이다.
