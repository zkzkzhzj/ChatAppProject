...
## 예약 현황 (마지막 사용 번호: 87, 마지막 예약 번호: 87)
...
| 87   | `realtime-infra-reset` | STOMP 유지 + raw WS 컷오버 조건 (ADR-010 학습노트 — 기능 parity vs 운영 parity, strangler fig) | ✅ 사용 완료 (2026-06-11) |

> 87번 이후는 트랙 추가 시 본 표에 5번 단위로 예약.
