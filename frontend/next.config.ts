...
const nextConfig: NextConfig = {
  ...
  output: "standalone",
  // 루트 ChatAppProject-ui/package-lock.json (husky 전용) 과 frontend/package-lock.json
  // 두 개를 모두 발견할 때 Next 16 이 루트를 workspace root 로 오인하여
  // 의존성 그래프 재계산이 폭주 (Node heap 폭식 → 강종) 하는 문제 차단.
  turbopack: {
